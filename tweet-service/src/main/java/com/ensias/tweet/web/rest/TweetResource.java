package com.ensias.tweet.web.rest;

import com.ensias.tweet.repository.TweetRepository;
import com.ensias.tweet.service.TweetService;
import com.ensias.tweet.service.dto.TweetDTO;
import com.ensias.tweet.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ensias.tweet.domain.Tweet}.
 */
@RestController
@RequestMapping("/api")
public class TweetResource {
    ...
    private static final String ENTITY_NAME = "tweetServiceTweet";
