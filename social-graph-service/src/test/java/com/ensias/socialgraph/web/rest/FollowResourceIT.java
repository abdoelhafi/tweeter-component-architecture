...
class FollowResourceIT {
    ...
    private static final Status DEFAULT_STATUS = Status.FOLLOW;
    private static final Status UPDATED_STATUS = Status.UNFOLLOW;
    ...
    public static Follow createEntity(EntityManager em) {
        Follow follow = new Follow().status(DEFAULT_STATUS);
        return follow;
    }
    ...
    public static Follow createUpdatedEntity(EntityManager em) {
        Follow follow = new Follow().status(UPDATED_STATUS);
        return follow;
    }
    ...
    void putNewFollow() throws Exception {
        ...
        updatedFollow.status(UPDATED_STATUS);
    ...
    void fullUpdateFollowWithPatch() throws Exception {
        ...
        partialUpdatedFollow.status(UPDATED_STATUS);
