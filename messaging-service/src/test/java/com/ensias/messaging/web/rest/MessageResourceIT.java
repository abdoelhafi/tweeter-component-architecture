package com.ensias.messaging.web.rest;
...
import com.ensias.messaging.IntegrationTest;
import com.ensias.messaging.domain.Message;
import com.ensias.messaging.repository.MessageRepository;
import com.ensias.messaging.service.dto.MessageDTO;
import com.ensias.messaging.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().messageText(DEFAULT_MESSAGE_TEXT);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().messageText(UPDATED_MESSAGE_TEXT);
        return message;
    }
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.messageText(UPDATED_MESSAGE_TEXT);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.messageText(UPDATED_MESSAGE_TEXT);
