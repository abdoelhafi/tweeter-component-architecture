...
export const FollowDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayServiceApp.socialGraphFollow.delete.question">Are you sure you want to delete this Follow?</ModalBody>
      <ModalFooter>
