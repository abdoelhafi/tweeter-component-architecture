...
export const TweetUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayServiceApp.tweetServiceTweet.home.createOrEditLabel" data-cy="TweetCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Content" id="tweet-content" name="content" data-cy="content" type="text" />
